...
class String{
	...
	void showAddress(){
		...
		for(i=0;i<len;i++){
			...
			/*https://stackoverflow.com/a/49273473 , static_cast<void>: this is used because otherwise the compiler
			will simply print the rest of the string, and not use the actual result of computation, which we want here.
			*/
		}
		return;
	}
